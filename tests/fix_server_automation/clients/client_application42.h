...
class ClientApplication42 : public FIX::Application, public FIX::MessageCracker
{
public:
    ...
    void send_replace_order(std::size_t orig_order_id)
    {
        try
        {
            ...
            FIX42::OrderCancelReplaceRequest replaceOrder(
...
private:
    ...
    void onMessage(const FIX42::ExecutionReport& report, const FIX::SessionID& sessionID)
    {
