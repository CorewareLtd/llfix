...
set "TRANSLATION_UNIT_NAMES="server.cpp" "%OPENSSL_ROOT_DIR%\ms\applink.c""
set "INCLUDE_PATHS=/I"./../../../../include" /I"%OPENSSL_ROOT_DIR%\include""
set "LINK_LIBS=Advapi32.lib user32.lib "%OPENSSL_ROOT_DIR%\lib\libssl.lib" "%OPENSSL_ROOT_DIR%\lib\libcrypto.lib""
