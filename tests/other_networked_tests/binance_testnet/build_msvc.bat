...
set "TRANSLATION_UNIT_NAMES="client.cpp" "%OPENSSL_ROOT_DIR%\ms\applink.c""
set "INCLUDE_PATHS=/I"./../../../include" /I"%OPENSSL_ROOT_DIR%\include" /I"../../../deps/tinyxml2/include""
set "LINK_LIBS=Advapi32.lib user32.lib "%OPENSSL_ROOT_DIR%\lib\libssl.lib" "%OPENSSL_ROOT_DIR%\lib\libcrypto.lib" /LIBPATH:"../../../deps/tinyxml2/lib" tinyxml2.lib"
