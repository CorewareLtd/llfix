...
public:
    ...
    void onMessage(const FIX50::NewOrderSingle& message, const FIX::SessionID& sessionID)
    {
        ...
        {
            // Reject
            FIX50::ExecutionReport exec_report;
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////
    // CANCEL ORDERS
    void onMessage(const FIX50::OrderCancelRequest& message, const FIX::SessionID& sessionID)
    {
        FIX::Symbol symbol;
        message.get(symbol);
        ...
        {
            // reject
            FIX50::OrderCancelReject reject;
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////
    // REPLACE ORDERS
    void onMessage(const FIX50::OrderCancelReplaceRequest& message, const FIX::SessionID& sessionID)
    {
        // EXTRACT MESSAGE FIELDS
        FIX::Symbol symbol;
        FIX::Side side;
...
private:
    ...
    void add_test_repeating_groups(FIX50::ExecutionReport& execReport)
    {
        FIX50::ExecutionReport::NoPartyIDs partyGroup1;
        ...
        FIX50::ExecutionReport::NoPartyIDs partyGroup2;
