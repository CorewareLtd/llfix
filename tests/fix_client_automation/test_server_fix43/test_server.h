...
public:
    ...
    void onMessage(const FIX43::Logon& logon, const FIX::SessionID& sessionID)
    {
    ...
    void onMessage(const FIX43::NewOrderSingle& message, const FIX::SessionID& sessionID)
    {
        ...
        if (symbol == m_fill_instrument)
        {
            ...
            for (std::size_t i = 0; i < requested_qty; i++)
            {
                ...
                FIX43::ExecutionReport exec_report = FIX43::ExecutionReport
        ...
        {
            // Reject
            FIX43::ExecutionReport exec_report;
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////
    // CANCEL ORDERS
    void onMessage(const FIX43::OrderCancelRequest& message, const FIX::SessionID& sessionID)
    {
        FIX::Symbol symbol;
        message.get(symbol);
        ...
        {
            // reject
            FIX43::OrderCancelReject reject;
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////
    // REPLACE ORDERS
    void onMessage(const FIX43::OrderCancelReplaceRequest& message, const FIX::SessionID& sessionID)
    {
        // EXTRACT MESSAGE FIELDS
        FIX::Symbol symbol;
        FIX::Side side;
...
private:
    ...
    void add_test_repeating_groups(FIX43::ExecutionReport& execReport)
    {
        FIX43::ExecutionReport::NoPartyIDs partyGroup1;
        ...
        FIX43::ExecutionReport::NoPartyIDs partyGroup2;
