...
set "TRANSLATION_UNIT_NAMES="server.cpp" "./messages/ExecutionReport.cpp" "./messages/NewOrderSingle.cpp" "%OPENSSL_ROOT_DIR%\ms\applink.c""
set "INCLUDE_PATHS=/I"./../../../include" /I"./../../../deps/tinyxml2/include" /I"%OPENSSL_ROOT_DIR%\include""
set "LINK_LIBS=Advapi32.lib user32.lib /LIBPATH:"./../../../deps/tinyxml2/lib" tinyxml2.lib /LIBPATH:"%OPENSSL_ROOT_DIR%\lib" "%OPENSSL_ROOT_DIR%\lib\libssl.lib" "%OPENSSL_ROOT_DIR%\lib\libcrypto.lib""
